                    ...
                    <form id="payment-form" role="form" method="POST" action="/store/order">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p>Example: (0000)-(0000)-(0000)-(0000)</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p>You can Find it at the back of the card (three digits): (000)</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <h6 class="text-center">
                                This payment system is powered by <a href="https://stripe.com/" target="_blank">Stripe</a>.
                            </h6>
                        </div>
